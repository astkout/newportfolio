      ...
      <div className="container">
        <div className="flex items-center justify-between flex-wrap">
          <div className="mb-5 sm:mb-0">
            <h3 className="text-headingColor font-[400] text-[2.5rem]">
              My Projects
            </h3>
          </div>
        ...
        <div className="flex items-center gap-4 flex-wrap mt-12">
          {portfolios?.slice(0, nextItems)?.map((portfolio, index) => (
            <div
              ...
              className="group max--full sm:w-[48.5%] md:w-[32.2%] relative z-[4]"
            >
              <figure>
                <img
        ...
        <div className="text-center mt-6">
          {nextItems < portfolios.length && data.length > 3 && (
            <button
              ...
              className="text-white bg-blue-500 hover:bg-smallTextColor py-2 px-4 rounded-[8px]
                  font-[500] ease-in duration-200"
            >
              Load More
            </button>
